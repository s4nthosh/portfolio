...
function App() {
  ...
  const TitleUpdate = () => {
    const tit_location = useLocation()
    useEffect(() => {
      switch (tit_location.pathname) {
        case '/':
          document.title = 'WebDeveloper||Santhosh kumar';
          break;
        case '/about':
          document.title = 'Santhosh kumar||About';
          break;
        case '/project':
          document.title = 'Project||Santhosh kumar';
          break;
        default:
          document.title = 'Santhosh kumar'
      }
    }, [tit_location])
    return null;
  }
